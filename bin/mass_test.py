...
background_coeffs = background.coeffs
#coeffs =[i.numpy() for i in background_coeffs] 
events = bmf.signal.generate_background_mass(background_coeffs, events_total=10000).numpy()
print(events)